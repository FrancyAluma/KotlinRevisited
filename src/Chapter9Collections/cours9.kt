...
import Chapter6AbstractClassesAndInterfaces.Vehicle
...
fun main () {
    ...
    /*
    In general . the Map's type takes the form: Map < key_type, value_type>
     */
    recipeMap = mapOf ( "Recipe1" to r1 , "Recipe2" to r2 , "Recipe3" to r3 )
